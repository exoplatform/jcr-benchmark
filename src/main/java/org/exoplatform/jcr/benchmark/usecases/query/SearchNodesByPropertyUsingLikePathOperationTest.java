 ...
 * @version $Id: SearchNodesByPropertyUsingLikePathOperationTest.java 111 2011-11-11 11:11:11Z rainf0x $
 */
public class SearchNodesByPropertyUsingLikePathOperationTest
   extends JCRTestBase
{
   /*
   ...
   public void doPrepare(TestCase tc, JCRTestContext context) throws Exception
   {
      ...
      sqlQuery = "select * from nt:base where dc:title = 'Exoplatform' and jcr:path like '/" + rootPath + "/%'";
