 ...
 */
public class FindMembershipByUserGroupAndTypeTest
   extends AbstractMembershipTest
{
   ...
   {
      mHandler.findMembershipByUserGroupAndType(nextUser().getUserName(), "/" + nextGroup().getGroupName(),
               nextMembershipType().getName());
   }
}
