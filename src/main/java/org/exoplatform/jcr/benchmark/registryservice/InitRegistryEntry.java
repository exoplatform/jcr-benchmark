 ...
 * @version $Id:$
 */
public class InitRegistryEntry extends AbstractRegistryServiceTest {
  ...
  public void doRun(TestCase tc, JCRTestContext context) throws Exception {
    registryService.initRegistryEntry(RegistryService.EXO_USERS,
                                      context.generateUniqueName("username"));
  }
}
