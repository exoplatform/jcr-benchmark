 ...
 * @version $Id$
 */
public abstract class AbstractWildCardPrefixWildCardNamePatternTest
   extends AbstractPatternTest
{

   protected String nodeNamePatern = "*:exectly_node_*";

   protected String properyNamePatern = "*:exectly_property_*";
