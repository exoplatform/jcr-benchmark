 ...
 * @version $Id$
 */
public abstract class AbstractExactlyPrefixNamePatternTest
   extends AbstractPatternTest
{

   protected String nodeNamePatern = "jcr:exectly_node_name";

   protected String properyNamePatern = "jcr:exectly_property_name";
