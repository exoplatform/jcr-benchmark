 ...
 * @version $Id$
 */
public abstract class AbstractWildCardPrefixExectlyNamePatternTest
   extends AbstractPatternTest
{

   protected String nodeNamePatern = "*:exectly_node_name";

   protected String properyNamePatern = "*:exectly_property_name";
